...
All tracks sourced from OpenGameArt.org. Most are CC0 (public domain).

## emerald_plains

- **explore**: "GrassLands Theme" by DST — CC0
  https://opengameart.org/content/grasslands-theme
- **combat**: "Battle Theme A" by cynicmusic — CC0
  https://opengameart.org/content/battle-theme-a
- **victory**: "Medieval: Victory Theme" by RandomMind — CC0
  https://opengameart.org/content/medieval-victory-theme

## twilight_forest

- **explore**: "Dark Forest Theme" by cynicmusic — CC0
  https://opengameart.org/content/dark-forest-theme
- **combat**: "Grizzly Dwarf Battle LOOP" from "Glizzy Elf Forest RPG Music Pack" by Zane Little Music — CC0
  https://opengameart.org/content/glizzy-elf-forest-rpg-music-pack
- **victory**: "Grizzly Dwarf Battle Victory LOOP" from same pack — CC0

## anvil_mountains

- **explore**: "Fantasy Choir 2" by Cesar da Rocha — CC0
...
- **victory**: "Victory Fanfare Short" by cynicmusic — CC0
...
- **explore**: "Loopable Dungeon Ambience" by JaggedStone — CC0
  https://opengameart.org/content/loopable-dungeon-ambience
- **combat**: "Battle Theme B" by cynicmusic — CC0
  https://opengameart.org/content/battle-theme-b-for-rpg
- **victory**: "Victory Fanfare Short" by cynicmusic — CC0 (same as anvil_mountains)
